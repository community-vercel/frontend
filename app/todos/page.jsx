...
import TodoPageHeader from '../components/todos/TodoPageHeader';
import ViewTabs from '../components/todos/ViewTabs';
import TodoFiltersSection from '../components/todos/TodoFiltersSection';
...
export default function TodosPage() {
  ...
  const handleTodoComplete = useCallback(async (id, title) => {
  ...
  const handleTodoDelete = useCallback(async (id, title) => {
    const handleConfirm = async () => {
      try {
        setConfirmModal(prev => ({ ...prev, loading: true }));
